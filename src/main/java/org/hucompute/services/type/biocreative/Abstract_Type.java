...
public class Abstract_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.hucompute.services.type.biocreative.Abstract");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "org.hucompute.services.type.biocreative.Abstract");
